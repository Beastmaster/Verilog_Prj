...
%-----------------------------------------------------------------------------------------------------------
	...
	coef_matrix=[-5 3 0 -3 5 -5 3 0 -3 6 -6 4 0 -4 7 -7 4 0 -5 8 -8 5 0 -5 10 -10 6 0 -7 12 -13 8 0 -9 16 -17 11 0 -13 24 -26 18 0 -24 46 -56 45 0 -105 510 510 -105 0 45 -56 46 -24 0 18 -26 24 -13 0 11 -17 16 -9 0 8 -13 12 -7 0 6 -10 10 -5 0 5 -8 8 -5 0 4 -7 7 -4 0 4 -6 6 -3 0 3 -5 5 -3 0 3 -5 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;

...
set_false_path -from [get_keepers *$cpu_0_oci_debug_path|monitor_ready]  -to [get_keepers *$cpu_0_jtag_tck_path|monitor_ready_sync1]
...
set_false_path -from [get_keepers *$cpu_0|hbreak_enabled] -to [get_keepers *$cpu_0_jtag_tck_path|debugack_sync1]
set_false_path -from *$cpu_0_jtag_sr*    -to *$cpu_0_jtag_sysclk_path|*jdo*
set_false_path -from sld_hub:sld_hub_inst* -to *$cpu_0_jtag_sysclk_path|uir_sync1
set_false_path -from sld_hub:sld_hub_inst* -to *$cpu_0_jtag_sysclk_path|udr_sync1
set_false_path -from sld_hub:sld_hub_inst|irf_reg* -to *$cpu_0_jtag_sysclk_path|ir*
set_false_path -from sld_hub:sld_hub_inst|sld_shadow_jsm:shadow_jsm|state[1] -to *$cpu_0_oci_debug_path|monitor_go

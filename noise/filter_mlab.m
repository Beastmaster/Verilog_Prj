...
%-----------------------------------------------------------------------------------------------------------
	...
	coef_matrix=[-8 -7 10 5 -12 -2 14 0 -15 3 16 -7 -16 12 16 -17 -14 23 12 -31 -7 40 0 -52 13 72 -39 -119 134 511 511 134 -119 -39 72 13 -52 0 40 -7 -31 12 23 -14 -17 16 12 -16 -7 16 3 -15 0 14 -2 -12 5 10 -7 -8 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
